...
describe("JS SDK v2 branding format", () => {
  ...
  test("scrape with branding format returns branding data", async () => {
    ...
    expect(result.branding?.components?.buttonPrimary?.background).toBe(
      "#E11D48",
    );
  });
