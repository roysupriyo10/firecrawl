...
function prepareExtractPayload(args: {
  ...
  if (args.allowExternalLinks != null)
    body.allowExternalLinks = args.allowExternalLinks;
  ...
  if (args.ignoreInvalidURLs != null)
    body.ignoreInvalidURLs = args.ignoreInvalidURLs;
...
export async function startExtract(
  http: HttpClient,
  args: Parameters<typeof prepareExtractPayload>[0],
