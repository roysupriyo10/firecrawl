...
defmodule Firecrawl do
  ...
  ## Returns
    ...
    * `{:error, exception}` on HTTP or validation failure
  """
  @spec parse_file(keyword(), keyword()) :: response()
  def parse_file(params \\ [], opts \\ []) do
    with {:ok, params} <- NimbleOptions.validate(params, @parse_file_schema) do
      Req.post(client(opts), url: "/parse", json: to_body(params, @parse_file_key_mapping))
    end
  end
  ...
  """
  @spec parse_file!(keyword(), keyword()) :: Req.Response.t()
  def parse_file!(params \\ [], opts \\ []) do
